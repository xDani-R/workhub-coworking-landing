...
const Espacios = () => {
  ...
  const heroImages = [
    '/img_espacios/hero_espacio_1.jpg',
    '/img_espacios/hero_espacio_2.jpg',
    '/img_espacios/hero_espacio_3.jpg',
  ];
  ...
  const sedes = [
    {
      ...
      image: '/img_espacios/sede_penalolen.jpg',
      colorBorde: '#DEF093',
      colorBoton: '#A1AE6A',
      ...
      imagePosition: 'left',
      circleIcon: '/img_espacios/planta.png',
      circleColor: '#DEF093',
    ...
    },
    {
      ...
      image: '/img_espacios/sede_lareina.jpg',
      colorBorde: '#F3CD6D',
      colorBoton: '#F3CD6D',
      ...
      imagePosition: 'right',
      circleIcon: '/img_espacios/ubicacion.png',
      circleColor: '#F3CD6D',
    ...
    },
    {
      ...
      image: '/img_espacios/sede_nunoa.jpg',
      colorBorde: '#8D65B8',
      colorBoton: '#8A66B0',
      ...
      imagePosition: 'left',
      circleIcon: '/img_espacios/asterisco.png',
      circleColor: '#8A66B0',
      circleOffset: { top: '25px', right: '25px' }
    }
  ];
        ...
        <div className={styles.container}>
          ...
          <div className={styles.introCard}>
            ...
            <div className={styles.introColLogo}>
              <img src="/img_espacios/logo_cowork.png" alt="Logo WorkHub" />
            </div>
            ...
            <div className={styles.ctaRight}>
              ...
              <div className={styles.ctaCircleItem} style={{ marginTop: '60px' }}>
                <div className={styles.ctaCircle} style={{ backgroundColor: '#8A66B0' }}>
                  <img src="/img_espacios/logo_cowork.png" alt="Logo" className={styles.ctaCircleImg} />
                </div>
              ...
              <div className={styles.ctaCircleItem} style={{ marginTop: '20px' }}>
                <div className={styles.ctaCircle} style={{ backgroundColor: '#C9D975' }}>
                  <img src="/img_espacios/planta.png" alt="Planta" className={styles.ctaCircleImg} />
                </div>
              ...
              <div className={styles.ctaCircleItem} style={{ marginTop: '10px' }}>
                <div className={styles.ctaCircle} style={{ backgroundColor: '#F3CD6E' }}>
                  <img src="/img_espacios/ubicacion.png" alt="Ubicación" className={styles.ctaCircleImg} />
                </div>
              ...
              <div className={styles.ctaCircleItem} style={{ marginTop: '0px' }}>
                <div className={styles.ctaCircle} style={{ backgroundColor: '#B6B7E4' }}>
                  <img src="/img_espacios/asterisco.png" alt="Asterisco" className={styles.ctaCircleImg} />
                </div>
