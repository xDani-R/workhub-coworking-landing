...
const Comunidad = () => {
  ...
  const heroImages = [
    '/img_comunidad/imagen1.jpg',
    '/img_comunidad/imagen2.jpg',
    '/img_comunidad/imagen3.jpg',
  ];
          ...
          <div className={styles.comunidadLayout}>
            <div className={styles.layoutRow}>
              ...
              <div className={styles.imagesPair}>
                <img src="/img_comunidad/imagen4.jpg" alt="Comunidad 4" />
                <img src="/img_comunidad/imagen5.jpg" alt="Comunidad 5" />
              </div>
            </div>
            <div className={styles.layoutRow}>
              <div className={styles.imagesPair}>
                <img src="/img_comunidad/imagen6.jpg" alt="Comunidad 6" />
                <img src="/img_comunidad/imagen7.jpg" alt="Comunidad 7" />
              </div>
              <div className={styles.counterCard}>
          ...
          <div className={styles.teamGrid}>
            <div className={styles.teamCard}>
              <div className={styles.cardIcon}>
                <img src="/img_comunidad/generar.jpg" alt="Generar redes" />
              </div>
              <h3>Generar Redes</h3>
            ...
            <div className={styles.teamCard}>
              <div className={styles.cardIcon}>
                <img src="/img_comunidad/fomentar.jpg" alt="Fomentar creatividad" />
              </div>
            ...
            <div className={styles.teamCard}>
              <div className={styles.cardIcon}>
                <img src="/img_comunidad/compartir.jpg" alt="Compartir habilidades" />
              </div>
            ...
            <div className={styles.teamCard}>
              <div className={styles.cardIcon}>
                <img src="/img_comunidad/construir.jpg" alt="Construir comunidad" />
              </div>
        ...
        <div className={styles.container}>
          <div className={styles.createShareGrid}>
            ...
            <div className={styles.createShareImages}>
              <img src="/img_comunidad/imagen8.jpg" alt="Espacio creativo 1" />
              <img src="/img_comunidad/imagen9.jpg" alt="Espacio creativo 2" />
            </div>
          </div>
        </div>
      </section>
