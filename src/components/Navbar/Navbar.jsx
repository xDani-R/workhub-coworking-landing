      ...
      <div className="container d-flex align-items-center">
        ...
        <nav className="collapse navbar-collapse" id="navbarPrincipal">
          <ul className={`navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center gap-1 ${styles.listaNave}`}>
            ...
            <li className="nav-item">
              <a className="nav-link" href="/espacios">Espacios</a>  {/* 👈 NUEVO - Enlace a Espacios */}
            </li>
            <li className="nav-item">
            ...
            {/* Instagram */}
            <li className="nav-item">
              <a className="nav-link" href="#Allfooter" aria-label="Instagram">
            ...
            {/* LinkedIn */}
            <li className="nav-item">
              <a className="nav-link" href="#Allfooter" aria-label="LinkedIn">
